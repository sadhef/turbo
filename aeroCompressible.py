...
class AeroComp:
    ...
    def __init__(self, aero_input):
        ...
        self.tip_dia = self._input_dict.get("tip_dia")
        self.htr = self._input_dict.get("htr", 0.5)
        self.hub_dia = self._input_dict.get("hub_dia",self.tip_dia*self.htr)
        self.sigma = self._input_dict.get("sigma",1)
        self.phi = self._input_dict.get("phi",0.7)
        self.eta_fan = self._input_dict.get("eta_fan",0.8)
